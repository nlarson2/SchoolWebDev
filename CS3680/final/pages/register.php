...
if(!isset($_SESSION['active'])) {
  ...
  <form action="includes/register.inc.php" method="post">
      ...
      <div class="form-group">
        <label for="uName">User Name:</label><?php if(!empty($_GET['u'])) echo "<span class='err'>*</span>";?>
        <input <?php if(!empty($_GET['u'])) echo "class='inputErr' ";?> type="text" class="form-control" name = "uName" id="uName" <?php if(!empty($uName)) echo "value=$uName"; ?>>
      </div>
      <div class="form-group">
