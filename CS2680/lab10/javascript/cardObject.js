var deck = []; // empty array to hold array of card objects
  // Initialize the array of card objects
  initDeck();
function initDeck() {
...
function getCardValue(i) {
    ...
    var FACE = 10;
    switch(i) {
        case 0:case 1:case 2:case 3: return(ACE); // ACES
        case 4:case 5:case 6:case 7:              //KINGS
        case 8:case 9: case 10: case 11:          // QUEENS
        case 12:case 13:case 14:case 15:            // JACKS
        case 16:case 17:case 18:case 19: return(FACE); // TENS
